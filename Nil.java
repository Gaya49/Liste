...
rappresentano la lista vuota, e null che invece rappresenta un elemento indefinito. In questa classe: this = oggetto istanziato = lista vuota. */
...
public class Nil extends List{
  ...
  public boolean empty(){return true;} //sempre vuoto Nil
  /** empty() e' costante = true sulla sottoclasse Nil, e' costante = false sulla sottoclasse Cons, dunque NON e' costante su List */

  public int size(){return 0;} //sempre zero elementi Nil
  /** size() e' costante = 0 sulla sottoclasse Cons, NON e'
costante sulla sottoclasse Cons, dunque NON e' costante su List */

  public boolean contains(int x){return false;} //sempre vuoto Nil
  /** contains(x) e' costante = false sulla sottoclasse Nil, NON e' costante sulla sottoclasse Cons, dunque NON e' costante su List */
...
/** insert. Metodo che aggiunge x a una lista
  ...
  public List insert(int x){ return new Cons(x, this); } //nodi con elementi sono Cons e il this indica puntatore dell elemento x
  ...
  public List append(List l){ return l; } //ho lista vuota Nil
